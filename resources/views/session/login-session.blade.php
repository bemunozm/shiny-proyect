          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <p class="mb-0">o entra con tus credenciales</p>
                </div>
                <div class="card-body">
                  <form role="form" method="POST" action="{{route('user.session')}}">
                    @csrf
                    <label>Email</label>
                    <div class="mb-3">
                      <input type="email" class="form-control" name="email" id="email" placeholder="Email" value="tucorreo@gmail.com" aria-label="Email" aria-describedby="email-addon">
                      @error('email')
                ...
                <small class="text-muted">Olvidaste tu contraseña? Restablecer
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('../assets/img/curved-images/patty.png')"></div>
              </div>
            </div>
          </div>
        </div>
