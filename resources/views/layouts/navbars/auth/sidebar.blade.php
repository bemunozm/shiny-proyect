...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        ...
        <span class="ms-3 font-weight-bold">Shiny Busca pega</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Busca empleo</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('postulaciones') ? 'active' : '') }} " href="{{ url('postulaciones') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
     ...
     {{-- <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('user-management') ? 'active' : '') }}" href="{{ url('user-management') }}">
            ...
            <span class="nav-link-text ms-1">Buscar empleos</span>
        </a>
      </li> 
      <li class="nav-item mt-2">
      ...
      {{--<li class="nav-item">
        <a class="nav-link {{ (Request::is('billing') ? 'active' : '') }}" href="{{ url('billing') }}">
          ...
          <span class="nav-link-text ms-1">BILLETERA SIN USAR</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('virtual-reality') ? 'active' : '') }}" href="{{ url('virtual-reality') }}">
          ...
          <span class="nav-link-text ms-1">Virtual Reality NO OCUPAR ES UNA BASURA</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('rtl') ? 'active' : '') }}" href="{{ url('rtl') }}">
          ...
          <span class="nav-link-text ms-1">RTL NO OCUPAR XD</span>
        </a>
      </li>--}}
